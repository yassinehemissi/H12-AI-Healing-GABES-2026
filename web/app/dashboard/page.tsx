...
const PollutionChart = dynamic(() => import("../(dashboard)/components/pollution-chart"), { ssr: false, loading: () => <div style={{ height: 300 }} /> });
const TopPollutants = dynamic(() => import("../(dashboard)/components/top-pollutants"), { ssr: false, loading: () => <div style={{ height: 300 }} /> });
const CompanyRadar = dynamic(() => import("../(dashboard)/components/company-radar"), { ssr: false, loading: () => <div style={{ height: 250 }} /> });
    ...
    <div className="dashboard">
      <header className="dash-header">
        ...
        <nav className="header-right" style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          <Link href="/dashboard" style={{ color: "#34d399", fontWeight: 600, textDecoration: "none", fontSize: "0.9rem" }}>Dashboard</Link>
          <Link href="/dashboard/analytics" style={{ color: "#94a3b8", fontWeight: 500, textDecoration: "none", fontSize: "0.9rem" }}>AI Analytics</Link>
